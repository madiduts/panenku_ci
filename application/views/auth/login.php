    ...
    <div class="flex w-full h-full">
        ...
        <div class="hidden lg:flex w-1/2 relative bg-brand-dark">
            ...
            <div class="absolute bottom-0 left-0 p-12 z-10 w-full">
                ...
                <p class="text-green-50 text-sm leading-relaxed max-w-md">Kelola lahan, pantau panen, dan tingkatkan produktivitas pertanian Anda dengan teknologi terkini.</p>
            </div>
        </div>
            ...
            <div class="w-full max-w-sm mx-auto">
                ...
                <form action="<?= base_url('auth/process_login') ?>" method="POST" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-sm font-medium text-gray-400 hover:text-brand-green">Lupa Password?</a>
                    </div>
